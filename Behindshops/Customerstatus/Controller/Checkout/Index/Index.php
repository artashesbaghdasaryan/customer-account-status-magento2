...
namespace Behindshops\Customerstatus\Controller\Checkout\Index;
...
class Index extends \Magento\Checkout\Controller\Index\Index 
{
    ...
    {   
        ...
        if($customerData = $this->_customerSession->getCustomerData()){
          if(!$customerData->getCustomAttribute('bhs_customer_status')->getValue()){
            $this->messageManager->addErrorMessage(__('Your account is disabled Please Enable it from your Settings'));
            return $this->resultRedirectFactory->create()->setPath('checkout/cart');
          }
